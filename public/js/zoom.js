...
if ($(".thumbs-slider").length > 0) {
    var direction = $(".ss-product-media-thumbs").data("direction");
    var thumbs = new Swiper(".ss-product-media-thumbs", {
      spaceBetween: 10,
      slidesPerView: "auto",
      freeMode: true,
      direction: "vertical",
...
(function ($) {
    ...
    var image_zoom = function () {
      if (matchMedia("only screen and (min-width: 768px)").matches) {
        ...
        var pane = document.querySelector('.ss-zoom-main');
      ...
      if (matchMedia("only screen and (min-width: 768px)").matches) {
        ...
        var pane1 = document.querySelector('.ss-zoom-main1');
