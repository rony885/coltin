        ...
        <div className="container">
          <div className="ss-shop-control grid-3 align-items-center">
            ...
            <ul className="ss-control-layout d-flex justify-content-center">
              <li
                className="ss-view-layout-switch sw-layout-2"
              ...
              <li
                className="ss-view-layout-switch sw-layout-3"
              ...
              <li
                className="ss-view-layout-switch sw-layout-4 active"
            ...
            <div className="control-sorting d-flex justify-content-end">
              <div className="dropdown-sort" data-bs-toggle="dropdown">
                  ...
                  <div className="widget-featured-products mb_36">
                    ...
                    <div className="featured-product-item">
                      ...
                      >
                        <img
                          className="lazyload img-product"
                          src="images/products/img-feature-3.png"
                          alt="image-feature"
                        />
                      </Link>
                      <div className="card-product-info">
              ...
              <div className="widget-facet effect_4">
                <div className="banners">
                  <Link to="#">
                    <img
                      className="lazyload img-product"
                      data-src="images/products/image-sidebar.png"
                    ...
                    <div className="product-item-container">
                      ...
                      <div className="right-block">
                        <div className="caption">
                          ...
                          <div className="price">
                            <div className="product-price">$17.3</div>
                          </div>
                    ...
                    <div className="product-item-container">
                      ...
                      <div className="right-block">
                        <div className="caption">
                          ...
                          <div className="price">
                            <div className="product-price">$13.3</div>
                          </div>
                          <ul className="list-color-product">
                            <li className="list-color-item color-swatch active">
                              <span className="tooltip">Black</span>
                    ...
                    <div className="product-item-container">
                      ...
                      <div className="right-block">
                        <div className="caption">
                          ...
                          <div className="price">
                            <div className="product-price--regular">$18</div>
                            <div className="price-item--sale">$7</div>
                          </div>
                          <ul className="list-color-product">
                            <li className="list-color-item color-swatch active">
                    ...
                    <div className="product-item-container">
                      ...
                      <div className="right-block">
                        <div className="caption">
                          ...
                          <div className="price">
                            <div className="product-price--regular">$26</div>
                            <div className="price-item--sale">$18</div>
                          </div>
                          <ul className="list-color-product">
                            <li className="list-color-item color-swatch active">
                              <span className="tooltip">Black</span>
                    ...
                    <div className="product-item-container">
                      ...
                      <div className="right-block">
                        <div className="caption">
                          ...
                          <div className="price">
                            <div className="product-price--regular">$16.95</div>
                            <div className="price-item--sale">$10</div>
                          </div>
                          <ul className="list-color-product">
                            <li className="list-color-item color-swatch active">
                              <span className="tooltip">Yellow</span>
                    ...
                    <div className="product-item-container">
                      ...
                      <div className="right-block">
                        <div className="caption">
                          ...
                          <div className="price">
                            <div className="product-price">$15.5</div>
                          </div>
                          <ul className="list-color-product">
                            <li className="list-color-item color-swatch active">
                              <span className="tooltip">Black</span>
