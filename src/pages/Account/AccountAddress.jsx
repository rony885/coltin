            ...
            <div className="col-lg-3">
              <div className="wrap-sidebar-account">
                <ul className="my-account-nav">
                  ...
                  <li>
                    <span className="my-account-nav-item active">Address</span>
                  </li>
                  <li>
              ...
              <div className="my-account-content account-address">
                <div className="widget-inner-address">
                  <div className="list-account-address">
                    <div className="account-address-item text-start">
                      <h6 className="mb_20">Address 1</h6>
                      <p>Entry theme</p>
                      <p>Ahoaio Street, Suite 567</p>
                      <p>New York</p>
                      <p>info@fashionshop.com</p>
                      <p className="mb_10">(212) 555-1234</p>
                      <div className="d-flex gap-10 justify-content-start">
                        <button className="ss-btn btn-fill justify-content-center btn-edit-address">
                          <span>Edit</span>
                        </button>
                        <button className="ss-btn btn-outline justify-content-center">
                          <span>Delete</span>
                        </button>
                      </div>
                      <form
                      ...
                      >
                        ...
                        <div className="box-field grid-2-lg">
                          <div className="ss-field style-1">
                            <input
                        ...
                        <div className="box-field">
                          <div className="select-custom">
                            ...
                            >
                              ...
                              <option defaultValue="Israel" data-provinces="[]">
                                Israel
                              </option>
                              <option
                                defaultValue="Italy"
                              ...
                              <option defaultValue="Norway" data-provinces="[]">
                                Norway
                              </option>
                              <option defaultValue="Poland" data-provinces="[]">
                                Poland
                              </option>
                              <option
                        ...
                        <div className="d-flex align-items-center justify-content-center gap-20">
                          <button type="button" className="ss-btn btn-fill">
                            Update address
                          </button>
                          <span className="ss-btn btn-fill btn-hide-edit-address">
                            Cancel
                          </span>
                        </div>
                      </form>
                  ...
                  <button className="ss-btn btn-fill btn-address mb_20">
                  ...
                  <form
                    ...
                    action="#"
                  >
                    <div className="title">Add Link new address</div>
                    <div className="box-field grid-2-lg">
                      <div className="ss-field style-1">
                        <input
                          className="ss-field-input ss-input"
                    ...
                    <div className="d-flex align-items-center justify-content-center gap-20">
                      ...
                      <span className="ss-btn btn-fill btn-hide-address">
                        Cancel
                      </span>
                    </div>
                  </form>
